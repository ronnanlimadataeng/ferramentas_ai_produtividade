...
- **Genspark**  
  Uso: plataforma de respostas conversacionais com IA generativa  
  Link: https://www.genspark.ai/  

- **GPT4All (by Nomic AI)**  
  Uso: chatbot de IA de código aberto para rodar localmente  
  Link: https://www.nomic.ai/gpt4all  

- **NotebookLM (Google)**  
  Uso: assistente de pesquisa e resumo de documentos com IA  
...
- **HeyGen**  
  Uso: geração de avatares e vídeos com IA  
  Link: https://www.heygen.com/  

- **Gamma App**  
  Uso: criação de apresentações e documentos com IA  
  Link: https://gamma.app/  

- **Lovable.dev**  
  Uso: prototipagem de apps e produtos com IA  
  Link: https://lovable.dev/?via=global20&gad_source=1  

- **V0 by Vercel**  
  Uso: ferramenta de design-to-code com IA  
  Link: https://v0.app/  

- **Opus Clip**  
  Uso: edição e recorte de vídeos longos em clipes curtos com IA  
  Link: https://clip.opus.pro/dashboard  

- **SimilarVideo AI**  
  Uso: busca de vídeos semelhantes com IA  
  Link: https://similarvideo.ai/pt  

- **Eraser**  
  Uso: ferramenta colaborativa de diagramação e documentação técnica  
  Link: https://www.eraser.io/  

- **EdrawMind**  
  Uso: mapas mentais e organização visual com IA  
  Link: https://www.edrawmind.com/  

- **MindMeister**  
  Uso: criação colaborativa de mapas mentais  
  Link: https://www.mindmeister.com/pt  

- **Miro**  
  Uso: quadro branco online colaborativo com IA  
  Link: https://miro.com/pt/  

- **IdeaMap AI**  
  Uso: geração automática de mapas mentais com IA  
  Link: https://ideamap.ai/  

- **Mapify**  
  Uso: organização de ideias em mapas interativos com IA  
  Link: https://mapify.so/pt  

- **DecorAI**  
  Uso: geração de ideias de interiores e exteriores com IA  
...
- **Langflow**  
  Uso: construção visual de fluxos de IA com LLMs  
  Link: https://www.langflow.org/  

- **CrewAI**  
  Uso: orquestração de agentes de IA para tarefas complexas  
  Link: https://www.crewai.com/  

- **Partyrock (AWS)**  
  Uso: criação de apps de IA sem código  
  Link: https://partyrock.aws/  

- **MGX.dev**  
  Uso: ambiente para desenvolvimento e deploy de modelos de IA  
  Link: https://mgx.dev/  

- **Base44**  
  Uso: framework para construção de aplicações com IA  
  Link: https://base44.com/  

- **Kiro.dev**  
  Uso: IDE online com suporte a IA  
  Link: https://kiro.dev/  
...
- **Plus AI for Google Slides**  
  Uso: criação de apresentações com IA no Google Slides  
  Link: https://www.plusdocs.com/plus-ai-for-google-slides  

- **aiPDF**  
  Uso: assistente de documentos de IA avançado  
  Link: https://aipdf.ai  

- **Crystal Knows**  
  Uso: análise de perfis de pessoas para comunicação eficaz  
  Link: https://www.crystalknows.com/home-draft  

- **String.com**  
  Uso: colaboração e gerenciamento de conteúdo com IA  
...
- **Refinder AI**  
  Uso: pesquisa universal e assistente de IA para trabalho  
...
- **AI Wedding Toast**  
  Uso: geração de discursos de casamento com IA  
  Link: https://aiweddingtoast.com  

- **Manus**  
  Uso: assistente de escrita com IA  
  Link: https://manus.im/app  

- **AI Studio (Google)**  
  Uso: ambiente do Google para testar e implantar modelos de IA  
  Link: https://aistudio.google.com/live  

- **Opal (Google)**  
  Uso: ferramenta experimental de IA para produtividade e criatividade  
